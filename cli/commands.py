...
def cmd_sync() -> None:
    """Sincroniza issues com o Linear."""
...
def cmd_vida() -> None:
    """Life Guard removido nesta versão."""
    notifier.warning("Life Guard não está disponível nesta versão.", "life_guard")
...
def cmd_retrospective() -> None:
    """Retrospective removido nesta versão."""
    notifier.warning("Retrospective não está disponível nesta versão.", "retrospective")
